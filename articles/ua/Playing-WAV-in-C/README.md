...
Сьогодні я покажу як відтворювати WAV в C
...
````
# Основна функція
Почнемо з основої функції: ```int wmain(int argc, wchar_t *argv[])```
...
ніж 1, то має запуститися те, що йде в дужках, в іншому випадку піде те, що в дужках в else, для того щоб цього не сталося потрібно запустити програму
